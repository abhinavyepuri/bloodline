...
class HospitalOrderAcceptRequest(BaseModel):
    unit_ids: Optional[List[str]] = Field(default=None, description="Optional specific available unit IDs to allocate")
    auto_dispatch: bool = Field(default=False, description="If true, immediately mark units as dispatched to ambulance")
